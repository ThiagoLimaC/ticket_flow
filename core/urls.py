...
urlpatterns = [
    ...
    path('chamados/<int:chamado_id>/atendimento/', views.registrar_atendimento_view, name='registrar_atendimento'),
    path('chamados/<int:chamado_id>/pecas/', views.adicionar_peca_view, name='adicionar_peca'),
]